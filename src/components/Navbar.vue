<template>
    <nav
            class="bg-gray-900 fixed w-full z-20 top-0 left-0 border-b  border-gray-600"
    >
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          isMenuOpen ? 'visible  order-5' : 'hidden'
            ...
            >
                <ul
                        class="flex flex-col p-4 md:p-0 mt-4 font-medium border  rounded-lg md:flex-row md:space-x-8 md:mt-0  bg-gray-800 md:bg-gray-900 border-gray-700"
                >
